...
##  Run the Code
The code is written in Python 3 and designed to scale efficiently using TensorFlow's `tf.data` APIs. It is fully executable on Google Colab with GPU acceleration, just click the badge below:
